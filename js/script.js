...
;
var places = new travel(['St. Charles Church', 'Zoo Vienna'], ['Karlsplatz 1', 'Maxingstraße 13b'], ['1010 Vienna', '1130 Wien'], ['images/place.jpg', 'images/place2.jpg']);
places.Rander();
...
;
var restaurant = new restaurants([' ', ' '], ['Kettenbrückengasse 19', 'Schönbrunner Straße 21'], ['1050 Vienna', '1050 Wien'], ['images/restaurant.png', 'images/restaurant2.png'], ['+43(1)5812308', '+43 1 58 528 56 l +43 ,1 58 528 56'], ['www.lemonleaf.at', 'http://www.sixta-restaurant.at/'], ['Lemon Leaf Thai Restaurant', 'SIXTA']);
restaurant.Rander();
...
;
var Event1 = new events(['Kris Kristofferson', 'Lenny Kravitz'], ['Wiener Stadthalle, Halle F, Roland Rainer Platz 1', 'Wiener Stadthalle - Halle D, Roland Rainer Platz 1'], ['1150 Wien', '1150 Wien'], ['images/event.jpg', 'images/event2.jpg'], ['Fri, 15. Jun.', 'Sat, 09.06.2018'], ['20:00', '19:30'], ['€58,50 EUR', '€ 47,80'], ['http://kriskristofferson.com/', 'www.lennykravitz.com/']);
Event1.Rander();
